...
/*
Plugin Name: wordpress-simple-social-share
Plugin URI: https://github.com/monsieurPaon/wordpress-simple-social-share
...
function add_social_share_icons($content)
{
    ...
    $icoPathFbk = plugin_dir_url(__FILE__) . 'ico/facebook.svg';
    $icoPathTwit = plugin_dir_url(__FILE__) . 'ico/twitter.png';
    $icoPathLink = plugin_dir_url(__FILE__) . 'ico/linkedIn.png';
    $icoPathInsta = plugin_dir_url(__FILE__) . 'ico/instagram.png';
